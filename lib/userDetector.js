...
module.exports = function (req, res, next) {
  ...
  req.cubxUserPassword = req.body.password
...
UserDetector.prototype.detectUser = function (localLogin, localPassword) {
  ...
  return new Promise(
    function (resolve, reject) {
      ...
      client.get('/_users/_design/couchapp-authentication-utils@_users/_view/viewUsersByLogin?startkey=["local","' + localLogin + '"]&endkey=["local","' + localLogin + '"]&stale=update_after', function (err, req, res, obj) {
        /*
         * Example result:
